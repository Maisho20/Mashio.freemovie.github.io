...
<head>
    ...
    <title>Ms. Marvel Episode 3</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/9xFmSh70LOfX7L7irdVyyJ2xRSp.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Ms. Marvel Episode 3</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        ...
        <h1>Destined</h1>
        <h2>Ms. Marvel Episode 3</h2>
        <p>Ahead of Aamir’s wedding, Kamala may face grave consequences due to a crucial decision she makes.</p>
        <li class="mark">
            <div class="image-eps">
