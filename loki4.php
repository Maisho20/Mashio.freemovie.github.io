...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/uQt2dCsVqOCoYeg0XOcOqGfkdN9.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Loki Episode 4</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            <a href="loki3.php" disabled  class="button">
