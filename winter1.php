...
<head>
    ...
    <title>The Falcon and the Winter Soldier Episode 1</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/9c9EUdeFfkyfCsHK65gtXRACRcZ.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>The Falcon and the Winter Soldier Episode 1</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            <a href="winter1.php" style="cursor: not-allowed;" class="button">
            ...
            <a href="winter2.php" class="button">
        ...
        <h2>The Falcon and the Winter Soldier Episode 1</h2>
        <p>Sam Wilson and Bucky Barnes realize that their futures are anything but normal.</p>
        <li class="mark">
            <div class="image-eps">
