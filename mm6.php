...
<head>
    ...
    <title>Ms. Marvel Episode 6</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/3cbOYF4iX2jEi5lTDQ5C0xAchPo.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Ms. Marvel Episode 6</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            ...
            <a href="mm6.php" style="cursor: not-allowed;" class="button">
        ...
        <h1>No Normal</h1>
        <h2>Ms. Marvel Episode 6</h2>
        <p>Back in Jersey, Kamala finds Kamran and protects him from Damage Control who will stop at nothing to take him in.</p>
        <li class="mark">
            <div class="image-eps">
