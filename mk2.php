...
<head>
    ...
    <title>Moon Knight Episode 2</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/oLmV6R7PoEMLJJ62bE4idOoG9WX.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Moon Knight Episode 2</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        ...
        <h2>Moon Knight Episode 2</h2>
        <p>As Steven reels from the fact that his life may not be his own, a mysterious partner emerges from the past as a war of the gods looms on the horizon.</p>
        <li class="mark">
            <div class="image-eps">
