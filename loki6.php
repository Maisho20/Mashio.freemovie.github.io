...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/98hGgYbNFP8GnZhJzAar22bWIAT.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Loki Episode 6</h2>
        </div>
        <!-- play btn -->
    ...
    <div class="about-movie container">
        <div class="bttn">
            <a href="loki5.php" disabled  class="button">
