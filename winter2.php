...
<head>
    ...
    <title>The Falcon and the Winter Soldier Episode 2</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/2e7oMGT1I6GXLfWLhdfRtAbrwBr.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>The Falcon and the Winter Soldier Episode 2</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            <a href="winter1.php" class="button">
        ...
        <h1>The Star-Spangled Man</h1>
        <h2>The Falcon and the Winter Soldier Episode 2</h2>
        <p>John Walker is named Captain America, and Sam and Bucky team up against a rebel group.</p>
        <li class="mark">
            <div class="image-eps">
