...
<head>
    ...
    <title>Ms. Marvel Episode 1</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/gaBBBVXwSED1XNHe2wyQypp6ead.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Ms. Marvel Episode 1</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            <a href="mm1.php" style="cursor: not-allowed;" class="button">
            ...
            <a href="mm2.php" class="button">
                <i class='bx bxs-skip-next-circle'></i>
                <span class="button-tittle">NEXT</span>
            </a>
        </div>
        <h1>Generation Why</h1>
        <h2>Ms. Marvel Episode 1</h2>
        <p>Kamala Khan attends Avengercon only to discover that she herself might have superpowers.</p>
        <li class="mark">
            <div class="image-eps">
