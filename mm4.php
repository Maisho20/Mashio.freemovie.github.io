...
<head>
    ...
    <title>Ms. Marvel Episode 4</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/aRR3GD9S2yHeVG7CCV5M1DTWHJc.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Ms. Marvel Episode 4</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        ...
        <h1>Seeing Red</h1>
        <h2>Ms. Marvel Episode 4</h2>
        <p>Kamala travels around the world to solve the mystery of the bangle and her family’s history.</p>
        <li class="mark">
            <div class="image-eps">
