...
<head>
    ...
    <title>Moon Knight Episode 6</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/7MYioODhkGFRGb95Z9Yc0snZHM2.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Moon Knight Episode 6</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            ...
            <a href="mk6.php" style="cursor: not-allowed;" class="button">
                <i class='bx bxs-skip-next-circle'></i>
                <span class="button-tittle">NEXT</span>
            </a>
        </div>
        <h1>Gods and Monsters</h1>
        <h2>Moon Knight Episode 6</h2>
        <p>With Layla tracking down Harrow, Marc, Steven, and Khonshu must return to Cairo to stop Ammit as she looks to threaten humanity once more.</p>
        <li class="mark">
            <div class="image-eps">
