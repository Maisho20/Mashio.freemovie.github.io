...
<head>
    ...
    <title>The Falcon and the Winter Soldier Episode 3</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/hPUqRJmslgeuaTVKogf9eVtgNs9.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>The Falcon and the Winter Soldier Episode 3</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            ...
            <a href="winter4.php" class="button">
        ...
        <h1>Power Broker</h1>
        <h2>The Falcon and the Winter Soldier Episode 3</h2>
        <p>Sam and Bucky go to a criminal safe haven to find information about the Super Soldier serum.</p>
        <li class="mark">
            <div class="image-eps">
