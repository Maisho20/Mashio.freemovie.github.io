...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/zEzhrtkH8Ziuzciy0z6q70zSqel.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Loki Episode 5</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            <a href="loki4.php" disabled  class="button">
