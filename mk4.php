...
<head>
    ...
    <title>Moon Knight Episode 4</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/ujPdwFsye9ojzFjPTcJ2yk227K7.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Moon Knight Episode 4</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        ...
        <h1>The Tomb</h1>
        <h2>Moon Knight Episode 4</h2>
        <p>Marc & Steven trek the Siwa Desert with Layla to find Ammit’s tomb, but the threats ahead look to protect the goddess’ resting place.</p>
        <li class="mark">
            <div class="image-eps">
