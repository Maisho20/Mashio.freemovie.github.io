...
<head>
    ...
    <title>Moon Knight Episode 1</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/uA81REU7p7bniOQfplpbGIMWCe.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Moon Knight Episode 1</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            <a href="mk1.php" style="cursor: not-allowed;" class="button">
        ...
        <h1>The Goldfish Problem</h1>
        <h2>Moon Knight Episode 1</h2>
        <p>Steven Grant, a mild-mannered man who works a mundane job, begins to suspect that his life may not be his own when an alter living inside him begins to emerge.</p>
        <li class="mark">
            <div class="image-eps">
