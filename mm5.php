...
<head>
    ...
    <title>Ms. Marvel Episode 5</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/2QQbp3vAnptEr8VRYmZCRqO5rPD.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Ms. Marvel Episode 5</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        ...
        <h1>Seeing Red</h1>
        <h2>Ms. Marvel Episode 5</h2>
        <p>The bangle reveals to Kamala secrets about her family lineage, as well as the truth behind the Veil.</p>
        <li class="mark">
            <div class="image-eps">
