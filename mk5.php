...
<head>
    ...
    <title>Moon Knight Episode 5</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/sYnW3wMnmAYK9SHtsOGqVFlZNde.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Moon Knight Episode 5</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        ...
        <h1>Asylum</h1>
        <h2>Moon Knight Episode 5</h2>
        <p>Marc & Steven search through their memories to find their truth or become left behind.</p>
        <li class="mark">
            <div class="image-eps">
