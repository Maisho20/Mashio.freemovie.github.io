...
<head>
    ...
    <title>The Falcon and the Winter Soldier Episode 6</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/6To8PyF6hcSuds94VF2BhHgVO0y.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>The Falcon and the Winter Soldier Episode 6</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            ...
            <a href="winter6.php" style="cursor: not-allowed;" class="button">
                <i class='bx bxs-skip-next-circle'></i>
                <span class="button-tittle">NEXT</span>
            </a>
        </div>
        <h1>One World, One People</h1>
        <h2>The Falcon and the Winter Soldier Episode 6</h2>
        <p>As The Flag Smashers escalate their efforts, Sam and Bucky take action.</p>
        <li class="mark">
            <div class="image-eps">
