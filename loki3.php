...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/aTjfWml9Prd8cUB9cfk8yOAEh7v.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>Loki Episode 3</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            <a href="loki2.php" disabled  class="button">
