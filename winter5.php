...
<head>
    ...
    <title>The Falcon and the Winter Soldier Episode 5</title>
...
<body>
    ...
    <div class="play-container container">
        <!-- play image -->
        <img src="https://image.tmdb.org/t/p/original/yEhyuWXJ17CNqv7KkxSWw3mmsB8.jpg" alt="" class="play-img">
        <!-- play text -->
        <div class="play-text">
            <h2>The Falcon and the Winter Soldier Episode 5</h2>
            <!-- ratings -->
            <!-- <div class="rating">
    ...
    <div class="about-movie container">
        <div class="bttn">
            ...
            <a href="winter6.php" class="button">
        ...
        <h1>Truth</h1>
        <h2>The Falcon and the Winter Soldier Episode 5</h2>
        <p>John Walker faces consequences for his actions, and Sam and Bucky return to the U.S.</p>
        <li class="mark">
            <div class="image-eps">
